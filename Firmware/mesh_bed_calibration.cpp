...
/*
static bool magnet_position(float x_pos, float y_pos) {
...
//	printf_P(PSTR("Iter: %d, Current pos.: %f \n\n"), n_iter, current_position[Z_AXIS]);
...
static void constraints(float &x_cor, float &y_cor) {
	if (x_cor > 210) x_cor = 210;
}

void find_z_with_span(float span, float center_x, float center_y) {
	...
	current_position[X_AXIS] = center_x + span;
	current_position[Y_AXIS] = center_y;
	world2machine_clamp(current_position[X_AXIS], current_position[Y_AXIS]);
	constraints(current_position[X_AXIS], current_position[Y_AXIS]);
	plan_buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS], XY_AXIS_FEEDRATE, active_extruder);
	...
	current_position[X_AXIS] = center_x;
	current_position[Y_AXIS] = center_y + span;
	world2machine_clamp(current_position[X_AXIS], current_position[Y_AXIS]);
	constraints(current_position[X_AXIS], current_position[Y_AXIS]);
	plan_buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS], XY_AXIS_FEEDRATE, active_extruder);
	st_synchronize();
